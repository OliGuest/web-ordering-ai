...
const OrderMenuTabs = ({ visible, handleShow }) => {
    ...
    const scrollToItem = (e) => {
        ...
        const scrollTo = document.getElementById("menu-list-wrapper-" + subCategoryId);
        const topMenu = document.getElementById("top-menu");
        if (container && scrollTo && topMenu) {
            const divTopHeight = scrollTo.getBoundingClientRect().top;
            const containerTop = container.getBoundingClientRect().top;
            let calc = divTopHeight - containerTop + container.scrollTop - topMenu.offsetHeight - 60;
            container.scrollTo({ top: calc, behavior: 'smooth' });
        }
    }
