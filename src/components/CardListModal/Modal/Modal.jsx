                ...
                <div className="icon-text-left">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        ...
                        <g mask="url(#mask0_925_6952)">
                            <path fillRule="evenodd" clipRule="evenodd" d="M2 26.7902H13.089V15.7012H2V26.7902Z" fill="#0D0D0D" />
                        </g>
                        <path fillRule="evenodd" clipRule="evenodd" d="M7.54345 21.0428C7.43045 21.0428 7.33845 21.1348 7.33845 21.2478C7.33845 21.4748 7.74945 21.4748 7.74945 21.2478C7.74945 21.1348 7.65645 21.0428 7.54345 21.0428ZM7.54351 22.5421C6.82951 22.5421 6.24951 21.9611 6.24951 21.2471C6.24951 20.5331 6.82951 19.9531 7.54351 19.9531C8.25751 19.9531 8.83851 20.5331 8.83851 21.2471C8.83851 21.9611 8.25751 22.5421 7.54351 22.5421Z" fill="#0D0D0D" />
                        <path fillRule="evenodd" clipRule="evenodd" d="M18.8248 20.7031C19.1258 20.7031 19.3698 20.9461 19.3698 21.2471C19.3698 21.5481 19.1258 21.7921 18.8248 21.7921C18.5228 21.7921 18.2798 21.5481 18.2798 21.2471C18.2798 20.9461 18.5228 20.7031 18.8248 20.7031Z" fill="#0D0D0D" />
                        ...
                        <g mask="url(#mask1_925_6952)">
                            <path fillRule="evenodd" clipRule="evenodd" d="M13.2798 26.7902H24.3698V15.7012H13.2798V26.7902Z" fill="#0D0D0D" />
                        </g>
                        <path fillRule="evenodd" clipRule="evenodd" d="M18.8238 21.0425C18.7118 21.0425 18.6198 21.1345 18.6198 21.2475C18.6208 21.4765 19.0308 21.4745 19.0298 21.2475C19.0298 21.1345 18.9368 21.0425 18.8238 21.0425ZM18.8238 22.5421C18.1098 22.5421 17.5298 21.9611 17.5298 21.2471C17.5298 20.5331 18.1098 19.9531 18.8238 19.9531C19.5388 19.9531 20.1198 20.5331 20.1198 21.2471C20.1198 21.9611 19.5388 22.5421 18.8238 22.5421Z" fill="#0D0D0D" />
                    </svg>
                    {timer &&
